...
# Example Usage:
# 
# gcc mapbookmarks.c; ./a.out "51.5122,-0.0904" > map-bookmarks-london.html
# gcc mapbookmarks.c; ./a.out "48.8563,2.3485" > map-bookmarks-paris.html
# gcc mapbookmarks.c; ./a.out "40.7161,-73.9912" > map-bookmarks-newyork.html
#
####################################
*/
...
int main(int argc, char *argv[])
{
  ...
  printf("<a href=\"https://www.geoplaner.com/?z=12;p=%s\">Geoplaner</a><br>\n", argv[1]);
